...
${TOOL_ROOT}/ccs/eclipse/eclipse -noSplash -data "$workspace" -application com.ti.ccstudio.apps.buildProject -ccs.projects ex2_obc_software "$configuration" -ccs.listErrors
