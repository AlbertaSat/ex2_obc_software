/**
 * @file    testing_CLI.c
 * @brief   Janky CLI for Josh's qualification testing of hardware functionality
 *          on newly-assembled Athena units. Has been frankensteined for use on
 *          latest hardware version (run 3), so might not exactly run smoothly :/
 * @author  Josh Lazaruk
 * @date    2022-06-26
 */
    ...
    while(1){
        ...
        switch(command){
                    ...
                    if(cmd2 == 'r'){
                        ...
                        while(1){
                            ...
                            if(cmd3 == '1'){
                                ...
                                ltoa(recvbytes, recvbytesstr, 10);
            ...
            case 'g': {
                ...
                while(1){
                    ...
                    if(cmd2 == 'o'){
                        ...
                        sciSend(sciREG4, strlen("GIOB2     HET2_11     HET1_24     HET1_15    GIOA7\r\n"), (unsigned char *)"GIOB2     HET2_11     HET1_24     HET1_15    GIOA7\r\n");
                        while(1){
                            ltoa((long)gioGetBit(gioPORTB, 2), &statuschar, 10);
                            sciSend(sciREG4, 1, &statuschar);
                            sciSend(sciREG4, strlen("         "), (unsigned char *)"         ");
                            ltoa((long)gioGetBit(hetPORT2, 11), &statuschar, 10);
                            sciSend(sciREG4, 1, &statuschar);
                            sciSend(sciREG4, strlen("         "), (unsigned char *)"         ");
                            ltoa((long)gioGetBit(hetPORT1, 24), &statuschar, 10);
                            sciSend(sciREG4, 1, &statuschar);
                            sciSend(sciREG4, strlen("          "), (unsigned char *)"          ");
                            ltoa((long)gioGetBit(hetPORT1, 15), &statuschar, 10);
                            sciSend(sciREG4, 1, &statuschar);
                            sciSend(sciREG4, strlen("          "), (unsigned char *)"          ");
                            ltoa((long)gioGetBit(gioPORTA, 7), &statuschar, 10);
                            sciSend(sciREG4, 1, &statuschar);
                            sciSend(sciREG4, strlen("\r\n"), (unsigned char *)"\r\n");
            ...
            case 'c': {
                ...
                while(1){
                    ...
                    if(cmd2 == 'r'){
                        ...
                        ltoa(recvframes, recvframesstr, 10);
            ...
            case 'r': {
                ...
                while(1){
                    ...
                    if (cmd2 == 'r'){
                        ...
                        uint8_t secs = 0;
                        char secsstr[2];
                        RTCMK_ReadSeconds(RTCMK_ADDR, &secs);
                        ltoa(secs, secsstr, 10);
            ...
            case 't': {
                ...
                sciSend(sciREG4, strlen(" 0x49      0x4A \r\n"), (unsigned char *)" 0x49      0x4A \r\n");
...
//                    for(j=0;j<6;j++){
//                        ltoa(measuredtemps[j], tempstr, 10);
//                        sciSend(sciREG4, 6, (unsigned char *)tempstr);
//                        sciSend(sciREG4, strlen("    "), (unsigned char *)"    ");
//                    }
                    tmp117_read(0x49, &temp);
//                    snprintf(tempstr, 4, "%2.1f", temp);
//                    sciSend(sciREG4, 6, (unsigned char *)tempstr);
//                    sciSend(sciREG4, strlen("    "), (unsigned char *)"    ");
                    tmp117_read(0x4A, &temp);
//                    sprintf(tempstr, "%2.1f", temp);
//                    sciSend(sciREG4, 6, (unsigned char *)tempstr);
//
//                    sciSend(sciREG4, strlen("\r\n"), (unsigned char *)"\r\n");
            ...
            case 'b': {
                ...
                sciSend(sciREG4, strlen("Activating port burnwire, press space to deactivate\r\n"), (unsigned char *)"Activating port burnwire, press space to deactivate\r\n");
                ...
                sciSend(sciREG4, strlen("Activating UHF port burnwire, press space to deactivate\r\n"), (unsigned char *)"Activating UHF port burnwire, press space to deactivate\r\n");
                ...
                sciSend(sciREG4, strlen("Activating UHF zenith burnwire, press space to deactivate\r\n"), (unsigned char *)"Activating UHF zenith burnwire, press space to deactivate\r\n");
                ...
                sciSend(sciREG4, strlen("Activating payload burnwire, press space to deactivate\r\n"), (unsigned char *)"Activating payload burnwire, press space to deactivate\r\n");
                ...
                sciSend(sciREG4, strlen("Activating starboard burnwire, press space to deactivate\r\n"), (unsigned char *)"Activating starboard burnwire, press space to deactivate\r\n");
                ...
                sciSend(sciREG4, strlen("Activating UHF starboard burnwire, press space to deactivate\r\n"), (unsigned char *)"Activating UHF starboard burnwire, press space to deactivate\r\n");
                ...
                sciSend(sciREG4, strlen("Activating DFGM burnwire, press space to deactivate\r\n"), (unsigned char *)"Activating DFGM burnwire, press space to deactivate\r\n");
                ...
                sciSend(sciREG4, strlen("Activating UHF nadir burnwire, press space to deactivate\r\n"), (unsigned char *)"Activating UHF nadir burnwire, press space to deactivate\r\n");
            ...
            case 'v': {
                ...
                sciSend(sciREG4, strlen("DFGM   UHF_P   UHF_Z   UHF_S   UHF_N   Port   Payload   Starboard\r\n"), (unsigned char *)"DFGM   UHF_P   UHF_Z   UHF_S   UHF_N   Port   Payload   Starboard\r\n");
                for(i=0;i<30000000;i++);
                int j;
                unsigned char statuschar;
                while(1){
                    ...
                    for(j=0;j<8;j++){
                        ltoa((long)switchstatus(j), &statuschar, 10);
                        sciSend(sciREG4, 1, &statuschar);
                        sciSend(sciREG4, strlen("        "), (unsigned char *)"        ");
                    }
                    sciSend(sciREG4, strlen("\r\n"), (unsigned char *)"\r\n");
            ...
            case 'p': {
                ...
                while(sciReceiveByte(sciREG4) != ' ');
                sciSend(sciREG4, strlen("Activating port CS, press space to deactivate\r\n"), (unsigned char *)"Activating port CS, press space to deactivate\r\n");
                ...
                while(sciReceiveByte(sciREG4) != ' ');
                sciSend(sciREG4, strlen("Activating port deployable CS, press space to deactivate\r\n"), (unsigned char *)"Activating port deployable CS, press space to deactivate\r\n");
                ...
                while(sciReceiveByte(sciREG4) != ' ');
                sciSend(sciREG4, strlen("Activating zenith CS, press space to deactivate\r\n"), (unsigned char *)"Activating zenith CS, press space to deactivate\r\n");
                ...
                while(sciReceiveByte(sciREG4) != ' ');
                sciSend(sciREG4, strlen("Activating starboard deployable CS, press space to deactivate\r\n"), (unsigned char *)"Activating starboard deployable CS, press space to deactivate\r\n");
                ...
                while(sciReceiveByte(sciREG4) != ' ');
                sciSend(sciREG4, strlen("Activating starboard CS, press space to deactivate\r\n"), (unsigned char *)"Activating starboard CS, press space to deactivate\r\n");
                ...
                while(sciReceiveByte(sciREG4) != ' ');
                sciSend(sciREG4, strlen("Activating Nadir CS, press space to deactivate\r\n"), (unsigned char *)"Activating Nadir CS, press space to deactivate\r\n");
