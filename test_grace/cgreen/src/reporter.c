...
TestReporter *get_test_reporter() { return context.reporter; }
...
void send_reporter_skipped_notification(TestReporter *reporter) { send_cgreen_message(reporter->ipc, skipped); }
