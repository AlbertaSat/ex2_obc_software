...
#ifndef O_NONBLOCK
#error                                                                                                            \
    "Your platform does not support POSIX ASYNC pipe reads. Please report a bug to http://github.com/cgreen-devs/cgreen/issues"
...
void cgreen_pipe_close(int p) { close(p); }
