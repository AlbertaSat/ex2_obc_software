...
#define ASSERT_THAT_VA_NUM_ARGS(...)                                                                              \
    ASSERT_THAT_VA_NUM_ARGS_IMPL_(                                                                                \
        (__VA_ARGS__, _CALLED_WITH_TOO_MANY_ARGS, _constraint, _expression, DummyToFillVaArgs))
...
void assert_string_not_equal_(const char *file, int line, const char *expression, const char *tried,
                              const char *expected);
void assert_that_double_(const char *file, int line, const char *actual_string, double actual,
