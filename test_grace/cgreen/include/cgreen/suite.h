...
#define create_test_suite() create_named_test_suite_(__func__, FILENAME, __LINE__)
#define create_named_test_suite(name) create_named_test_suite_(name, FILENAME, __LINE__)
#define add_test(suite, test) add_test_(suite, STRINGIFY_TOKEN(test), &spec_name(default, test))
#define add_test_with_context(suite, context, test)                                                               \
    add_test_(suite, STRINGIFY_TOKEN(test), &spec_name(context, test))
