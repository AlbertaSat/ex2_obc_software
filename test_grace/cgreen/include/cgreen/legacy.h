...
#define assert_true(result)                                                                                       \
    (*cgreen::get_test_reporter()->assert_true)(cgreen::get_test_reporter(), FILENAME, __LINE__, (result),        \
                                                "[" STRINGIFY_TOKEN(result) "] should be true\n", NULL)
#define assert_false(result)                                                                                      \
    (*cgreen::get_test_reporter()->assert_true)(cgreen::get_test_reporter(), FILENAME, __LINE__, !(result),       \
                                                "[" STRINGIFY_TOKEN(result) "] should be false\n", NULL)
...
/* Legacy style asserts (for C):*/
#define assert_true(result)                                                                                       \
    (*get_test_reporter()->assert_true)(get_test_reporter(), FILENAME, __LINE__, (result),                        \
                                        "[" STRINGIFY_TOKEN(result) "] should be true\n", NULL)
#define assert_false(result)                                                                                      \
    (*get_test_reporter()->assert_true)(get_test_reporter(), FILENAME, __LINE__, !(result),                       \
                                        "[" STRINGIFY_TOKEN(result) "] should be false\n", NULL)
...
#define assert_false_with_message(result, ...)                                                                    \
    (*get_test_reporter()->assert_true)(get_test_reporter(), FILENAME, __LINE__, !(result), __VA_ARGS__)
#define assert_equal_with_message(tried, expected, ...)                                                           \
    (*get_test_reporter()->assert_true)(get_test_reporter(), FILENAME, __LINE__, ((tried) == (expected)),         \
                                        __VA_ARGS__)
#define assert_not_equal_with_message(tried, expected, ...)                                                       \
    (*get_test_reporter()->assert_true)(get_test_reporter(), FILENAME, __LINE__, ((tried) != (expected)),         \
                                        __VA_ARGS__)
#define assert_double_equal_with_message(tried, expected, ...)                                                    \
    (*get_test_reporter()->assert_true)(get_test_reporter(), FILENAME, __LINE__,                                  \
                                        doubles_are_equal((tried), (expected)), __VA_ARGS__)
#define assert_double_not_equal_with_message(tried, expected, ...)                                                \
    (*get_test_reporter()->assert_true)(get_test_reporter(), FILENAME, __LINE__,                                  \
                                        doubles_are_equal((tried), (expected)), __VA_ARGS__)
