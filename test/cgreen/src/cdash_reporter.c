...
static void cdash_show_fail(TestReporter *reporter, const char *file, int line, const char *message,
                            va_list arguments);
static void cdash_show_pass(TestReporter *reporter, const char *file, int line, const char *message,
                            va_list arguments);
static void cdash_show_incomplete(TestReporter *reporter, const char *file, int line, const char *message,
                                  va_list arguments);

static void cdash_finish_test(TestReporter *reporter, const char *filename, int line, const char *message);
...
TestReporter *create_cdash_reporter(CDashInfo *info) {
    ...
    memo->printer(memo->stream,
                  ...
                  memo->info->os_name, memo->info->hostname, memo->info->os_release, memo->info->os_version,
                  memo->info->os_platform, strstart);
    fflush(memo->stream);
