...
#define will_set_contents_of_parameter(parameter_name, pointer_to_value, size)                                    \
    create_set_parameter_value_constraint(#parameter_name, (intptr_t)pointer_to_value, (size_t)size)
