...
////}
////
////static void mixed_parameters(int i, uint8_t *s) {
////    mock(i, s);
////}
////
...
////    expect(mixed_parameters, when(i, is_equal_to(1)), when(s, is_equal_to(1)));
////    expect(mixed_parameters, when(i, is_equal_to(2)), when(s, is_equal_to(1)), returns());
////    mixed_parameters(1, 1);
////    mixed_parameters(2, 1);
////}
////
