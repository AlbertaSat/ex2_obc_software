...
int main(int argc, char **argv) {
    ...
    xTaskCreate((TaskFunction_t)fifo_rx, "fifo rx", 128, NULL, configMAX_PRIORITIES - 1, NULL);
    ...
    if (start_time_management_service() != SATR_OK || start_communication_service() != SATR_OK) {
