...
typedef struct {
    ...
    uint8_t seq_flags; /* 3 bits, definition in TC_SEQ_xPACKET */ // HANDLED BY CSP
    uint16_t seq_count; /* 14 bits, packet counter, should be unique for each app id */ // HANDLED BY CSP
